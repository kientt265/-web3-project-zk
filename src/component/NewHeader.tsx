        ...
        <div className='fixed top-0 left-0 w-full z-50 bg-slate-200'>
            <div className='flex bg-white-300 p-3 items-center'>
                ...
                <div className='flex justify-around items-center w-[25%]'>
                    <p className='font-bold cursor-pointer bg-[#FFFFFF] rounded p-2 ' onClick={onLoginClick}>Log In</p> {/* Thêm sự kiện nhấn */}
                    <div>
                        <p className='font-bold bg-[#525FE1] rounded p-2 cursor-pointer' onClick={onSignUpClick}>Sign Up</p> {/* Thêm sự kiện nhấn */}
                    </div>
